	...
	<div id="HomeFuncAccordion" class="easyui-accordion" style="width:213px;"
		...
		<div title="设备管理" data-options="selected:true" style="padding:10px">
			<ul id="deviceMonitor" class="easyui-tree" data-options="animate:true,lines:true">
				<li><span>设备管理</span>
					<ul>
						<li id=21 data-options="attributes:{'url':'deviceList/deviceList'}">设备台账</li>
						<li id=22 data-options="attributes:{'url':'deviceType/deviceType'}">设备种类</li>
						<li id=23 data-options="attributes:{'url':'deviceCheck/deviceCheck'}">设备例检</li>
						<li id=24 data-options="attributes:{'url':'deviceFault/deviceFault'}">设备故障</li>
						<li id=25 data-options="attributes:{'url':'deviceMaintain/deviceMaintain'}">设备维修</li>
					</ul></li>
			</ul>
		</div>
